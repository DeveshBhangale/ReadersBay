...
<div style=padding:5px;text-align:center;>
  <h1 style="font-size:50px;"><font color="red">LOVE SHORT STORY</font></h1>
</div>
...
$res= mysqli_query($a,"select * from lovestory");
...
?>
  ...
  <div class="right">
  <form action ="lovestorydb.php" method="post">
