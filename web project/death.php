...
body {
  ...
  background-image:url("darkquotes.jpg");
...
<div style=padding:5px;text-align:center;>
  <h1 style="font-size:50px;"><font color="red">DEATH QUOTES</font></h1>
</div>
...
$res= mysqli_query($a,"select * from death");
...
?>
  ...
  <div class="right">
  <form action ="deathdb.php" method="post">
