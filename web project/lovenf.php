...
body {
  background-image:url("lovenf.jpg");
...
<div style=padding:5px;text-align:center;>
  <h1 style="font-size:50px;"><font color="red">LOVE QUOTES</font></h1>
</div>


  <div class="menu">
   <div class="dropdown">
  <button onclick="myFunction()" class="dropbtn" margin-left="7px" >CATEGORY</button><br/>
...
$res= mysqli_query($a,"select * from lovequotes");
while($row=mysqli_fetch_array($res))
{
?> 
   <pre text align="center" style="font-size: 25px"><?php echo $row["data"]; ?><br /></pre>
...
?>
  ...
  <div class="right">
  <form action ="lovenfdb.php" method="post">
